...
| ------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| v1.0.2  | 2026-07-05 | Parche de correcciones y mejoras de UX: perfil de proveedor, usuarios fuera de México, auditoría, soporte de modo oscuro en componentes, CLUES 9998, transferencia de trabajadores y estabilidad de PDFs. | Parche            |
...
| Campo                           | Valor                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Descripción**                 | Parche de la línea **v1.0** con correcciones y mejoras de UX identificadas tras el despliegue de v1.0.1. **(1) Perfil de proveedor (frontend):** precarga del formulario al navegar sin recargar la página; corrección al guardar proveedores en régimen **SIN_REGIMEN** evitando revalidación regulatoria innecesaria cuando el país no cambia; procesamiento automático de logotipo a PNG 500×500 px (`processProviderLogo`). **(2) Usuarios fuera de México (frontend):** correcciones en captura y visualización de campos geográficos para proveedores no mexicanos. **(3) Auditoría (frontend):** mejora de responsividad en la vista de auditoría. **(4) Exportación GIIS (frontend):** generación de `CEX.txt` condicionada a variable de entorno. **(5) CLUES (backend):** excepción del código sentinela **9998** (servicios médicos privados). **(6) Transferencia de trabajadores (backend):** registro de evento de auditoría al transferir trabajadores entre empresas. **(7) Estabilidad (backend):** silenciador de errores por PDF no disponible; correcciones de herencia de `createdBy`; compatibilidad cross-tenant en expedientes clonados; prevención de operaciones cross-tenant; ajuste de márgenes en examen de vista para firma visible. **(8) Modo oscuro (frontend):** ampliación del soporte visual en modo oscuro en componentes y vistas que aún presentaban bajo contraste o fondos incompatibles; incluye ajustes en `dark-mode.css`, modales de trabajo, visualizadores de documentos clínicos, tablas de riesgos de trabajo, dashboard de RTs, formularios de captura (selectores de país/teléfono, cuestionarios, nota médica, audiometría) y pantallas de autenticación. |
| **Tipo de cambio**              | Parche                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Evidencia de pruebas**        | Pruebas manuales de perfil de proveedor (navegación, guardado en SIN_REGIMEN y SIRES_NOM024, carga de logotipo); pruebas manuales de usuarios no mexicanos; specs existentes del backend según módulos modificados; verificación manual del modo oscuro en vistas y modales afectados (contraste, inputs, tablas y botones).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
