...
export class CreateExploracionFisicaDto {
  ...
  @Type(() => Date)
  @IsNotEmpty({
    message: 'La fecha de la exploración fisica no puede estar vacía',
  })
  ...
  @IsOptional()
  @IsEnum(categoriasIMC, {
    message: 'La categoria debe ser alguna de las siguientes: ' + categoriasIMC,
  })
  categoriaIMC: string;
  ...
  @IsOptional()
  @IsEnum(categoriasCircunferenciaCintura, {
    message:
      'La categoria debe ser alguna de las siguientes: ' +
      categoriasCircunferenciaCintura,
  })
  ...
  @IsOptional()
  @IsEnum(categoriasFrecuenciaCardiaca, {
    message:
      'La categoria debe ser alguna de las siguientes: ' +
      categoriasFrecuenciaCardiaca,
  })
  ...
  @IsOptional()
  @IsEnum(categoriasFrecuenciaRespiratoria, {
    message:
      'La categoria debe ser alguna de las siguientes: ' +
      categoriasFrecuenciaRespiratoria,
  })
  ...
  @IsOptional()
  @IsEnum(categoriaSaturacionOxigeno, {
    message:
      'La categoria debe ser alguna de las siguientes: ' +
