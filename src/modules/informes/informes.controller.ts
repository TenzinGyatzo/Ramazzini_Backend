...
export class InformesController {
  ...
  async getInformeAntidoping(
    ...
    try {
      const rutaPDF = await this.informesService.getInformeAntidoping(
        empresaId,
        trabajadorId,
        antidopingId,
        userId,
  ...
  async getInformeAudiometria(
    ...
    const rutaPDF = await this.informesService.getInformeAudiometria(
      empresaId,
      trabajadorId,
      audiometriaId,
      userId,
  ...
  @Get(
    'certificadoExpedito/:empresaId/:trabajadorId/:certificadoExpeditoId/:userId',
  )
  ...
  @Get(
    'exploracionFisica/:empresaId/:trabajadorId/:exploracionFisicaId/:userId',
  )
  ...
  async getInformeNotaMedica(
    ...
    try {
      const rutaPDF = await this.informesService.getInformeNotaMedica(
        empresaId,
        trabajadorId,
        notaMedicaId,
        userId,
      ...
      console.error(
        '[getInformeNotaMedica] Error al generar el informe nota médica:',
        error,
      );
      throw error;
    }
  ...
  @Get(
    'constanciaAptitud/:empresaId/:trabajadorId/:constanciaAptitudId/:userId',
  )
  ...
  async getInformeControlPrenatal(
    ...
    try {
      const rutaPDF = await this.informesService.getInformeControlPrenatal(
        empresaId,
        trabajadorId,
        controlPrenatalId,
        userId,
      ...
      console.error(
        '[getInformeControlPrenatal] Error al generar el informe control prenatal:',
        error,
      );
      throw error;
    }
  ...
  @Get(
    'historiaOtologica/:empresaId/:trabajadorId/:historiaOtologicaId/:userId',
  )
  async getInformeHistoriaOtologica(
    ...
    try {
      const rutaPDF = await this.informesService.getInformeHistoriaOtologica(
        empresaId,
        trabajadorId,
        historiaOtologicaId,
        userId,
      ...
      console.error(
        '[getInformeHistoriaOtologica] Error al generar el informe historia otologica:',
        error,
      );
      throw error;
    }
  ...
  @Get(
    'previoEspirometria/:empresaId/:trabajadorId/:previoEspirometriaId/:userId',
  )
  async getInformePrevioEspirometria(
    ...
    try {
      const rutaPDF = await this.informesService.getInformePrevioEspirometria(
        empresaId,
        trabajadorId,
      ...
      console.error(
        '[getInformePrevioEspirometria] Error al generar el informe previo espirometria:',
        error,
      );
      throw error;
    }
  ...
  async getInformeReceta(
    ...
    try {
      const rutaPDF = await this.informesService.getInformeReceta(
        empresaId,
        trabajadorId,
        recetaId,
        userId,
      ...
      console.error(
        '[getInformeReceta] Error al generar el informe receta:',
        error,
      );
      throw error;
    }
