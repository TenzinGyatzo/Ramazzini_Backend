import type {
  ...
  import type { DiagnosticoCardiometabolico } from '../../expedientes/schemas/cardiometabolico.enums';
  import type {
  ...
  interface DatosEventoSeguimientoCardiometabolicoInforme {
    fechaControlCardiometabolico: Date | string;
  ...
  export const eventoSeguimientoCardiometabolicoInforme = (
    ...
    const fechaControlCardiometabolico =
      escc.fechaControlCardiometabolico instanceof Date
        ? escc.fechaControlCardiometabolico
        : new Date(escc.fechaControlCardiometabolico as string);
              ...
              [
                ...
                },
                {
                  text: [
                    ...
                    {
                      text: formatearFechaUTC(fechaControlCardiometabolico),
                      style: 'fecha',
                      bold: true,
                    },
                  ],
